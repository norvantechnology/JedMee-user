...
const ROUTES = [
  ...
  },
  {
    ...
    requiredTypes: ["Article", "WebPage", "BreadcrumbList", "FAQPage", "Service"],
  },
  {
    path: "/pharmacy-billing-guide",
    outFile: "pharmacy-billing-guide/index.html",
    url: `${SITE}/pharmacy-billing-guide`,
    requiredTypes: ["Article", "WebPage", "BreadcrumbList", "FAQPage", "HowTo", "Service"],
  },
  {
  ...
  },
  {
    ...
    url: `${SITE}/free-trial`,
    requiredTypes: ["Article", "WebPage", "BreadcrumbList", "FAQPage"],
  },
  {
